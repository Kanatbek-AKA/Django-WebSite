    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='week3.course3')),
            ],
        ),
        migrations.CreateModel(
            name='Learner3',
        ...
        migrations.AddField(
            model_name='course3',
            name='instructors',
            field=models.ManyToManyField(to='week3.instructor3'),
        ),
        migrations.AddField(
            model_name='course3',
            name='users',
            field=models.ManyToManyField(through='week3.Enrollment3', to=settings.AUTH_USER_MODEL),
        ),
    ]
