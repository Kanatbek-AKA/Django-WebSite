...
def popular_course_list(request):
	...
	if request.method == "GET" :
		...
		course_list2 = Course2.objects.order_by('-total_enrollment')[:10]   # descending order slice 10 values
...
def enroll(request, course2_id):
	if request.method == 'POST' :
		...
		return HttpResponseRedirect(reverse(viewname= 'lab2:course_details', args=(course2.id, )))
