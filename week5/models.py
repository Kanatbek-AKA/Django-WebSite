...
class Course5(models.Model):
    ...
    total_enrollment = models.IntegerField(default=0)   # validators=[MaxValueValidator[999999999]]
    is_enrolled = False
...
class Question5(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    lesson = models.ForeignKey(Lesson5, on_delete=models.CASCADE)
    # question text
...
class Submission5(models.Model):
    ...
    chocies = models.ManyToManyField(Choice5)
#    Other fields and methods you would like to design
