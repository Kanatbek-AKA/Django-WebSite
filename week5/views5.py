...
from .models import Course5, Enrollment5, Submission5, examGrades5, Question5, Choice5, Learner5, Instructor5
# 
...
def registration_request(request):
    ...
    if request.method == 'GET':
        return render(request, 'onlinecourse/user_registration_bootstrap.html', context5)
...
def enroll5(request, course5_id):
    ...
    return HttpResponseRedirect(reverse(viewname='lab5:course_detailsF', args=(course5.id,)))
...
def submit5(request, course5_id):
    ...
    return HttpResponseRedirect(reverse(viewname='lab5:show_exam_resultF', args=(course5.id, submission.id)))
...
def show_exam_result(request, course5_id, submission5_id):
    ...
    total['grade'] =  total_score # round((100 * (total_score - total_wrong)/ total_score), 2)  # exam_grade_final 
