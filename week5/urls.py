...
urlpatterns = [
    ...
    path(
        "project/course5/<int:pk>/",
        views5.CourseDetailView3.as_view(),
        name="course_detailsF",
    ),
    ...
    path(
        "project/course5/<int:course5_id>/submission/<int:submission5_id>/result/",
        views5.show_exam_result,
        name="show_exam_resultF",
    ),
