...
def logout_request(request):
   ...
   # logout user 
   logout(request)
   return redirect("lab4:popular_course_list3")   # also the name for html pages inside views
...
class EnrollView2(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        course4.save()
        return HttpResponseRedirect(reverse(viewname='lab4:course_details3', args=(course4.id,)))
